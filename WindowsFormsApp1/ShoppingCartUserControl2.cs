...
{
    public partial class ShoppingCartUserControl2 : UserControl
    {
        string str圖檔名稱 = "";
        public ShoppingCartUserControl2()
        {
            InitializeComponent();
        }

        private void ShoppingCartUserControl2_Load(object sender, EventArgs e)
        {
            顯示商品詳細資訊();
        }
        void 顯示商品詳細資訊()
