...
{
    public partial class ShoppingCart3 : UserControl
    {
        //string str圖檔名稱 = "";
        ...
        private void ShoppingCart3_Load(object sender, EventArgs e)
        {
            //顯示商品詳細資訊();
        ...
        public void btn關閉_Click(object sender, EventArgs e)
        {
            //this.Parent.Controls.Remove(this);
            TabPage parentTabPage = this.Parent as TabPage;

            if (parentTabPage != null)
            {
                // 獲取父容器 TabControl
                TabControl parentTabControl = parentTabPage.Parent as TabControl;

                if (parentTabControl != null)
                {
                    // 移除 TabPage
                    parentTabControl.TabPages.Remove(parentTabPage);
                }
            }
        }
        ...
        private void AutoResizeTextBox(TextBox textBox)
        {
            ...
            //int textWidth = TextRenderer.MeasureText("Sample", textBox.Font).Width + 10;
